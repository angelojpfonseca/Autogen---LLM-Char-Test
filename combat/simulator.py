...
class CombatSimulator:
    def __init__(self, map_width=20, map_height=10):
        self.characters = []
        self.turn_manager = None
        self.battle_map = create_battle_map(map_width, map_height)
    ...
    def simulate_combat(self):
        ...
        self.battle_map.print_map(self.characters)
        
        while len([c for c in self.characters if c.is_alive()]) > 1:
            ...
            # Movement
            move_distance = random.randint(0, min(current_character.movement_remaining, 5))  # Limit movement for simplicity
    ...
    def _print_map_with_characters(self):
        self.battle_map.print_map(self.characters)